...
*/
GLfloat* NewPyramid::makeNewPyramidVertices(GLfloat width, GLfloat height, GLfloat depth, GLfloat* color) {
    ...
    GLfloat p2[3] = {0, -halfOfHeight, 0}; // 2 front
    GLfloat p3[3] = {0, -halfOfHeight, 0}; // 3 front
    GLfloat p4[3] = {-halfOfWidth, +halfOfHeight, -halfOfDepth}; // 4 back
    GLfloat p5[3] = {+halfOfWidth, +halfOfHeight, -halfOfDepth}; // 5 back
    GLfloat p6[3] = {0, -halfOfHeight, 0}; // 6 back
    GLfloat p7[3]= {0, -halfOfHeight, 0}; // 7 back
     */

     // Definition of positions of vertices for a cuboid
    GLfloat p0[3] = {0, +halfOfHeight, 0}; // 0 front
    GLfloat p1[3] = {0, +halfOfHeight, 0}; // 1 front
    GLfloat p2[3] = {+halfOfWidth, -halfOfHeight, +halfOfDepth}; // 2 front
    GLfloat p3[3] = {-halfOfWidth, -halfOfHeight, +halfOfDepth}; // 3 front
    GLfloat p4[3] = {0, +halfOfHeight, 0}; // 4 back
    GLfloat p5[3] = {0, +halfOfHeight, 0}; // 5 back
 ...
 */
GLint* NewPyramid::makeNewPyramidIndicesForTriangleStrip() {
     ...
     * @return list of vertices
     */
     GLfloat* NewPyramid::makeFastNewPyramidVertices(GLfloat width, GLfloat height, GLfloat depth, GLfloat* color) {
...
*/
GLint* NewPyramid::makeFastNewPyramidIndicesForTriangleStrip() {
...
GLint NewPyramid::getNoOfIndicesForFastNewPyramid(){
         return noOfIndicesForFastNewPyramid();
     }

GLint NewPyramid::getNoOfIndicesForNewPyramid(){
    return noOfIndicesForNewPyramid();
}

GLint NewPyramid::getNoOfVerticesForFastNewPyramid(){
         return 48;
     }

GLint NewPyramid::getNoOfVerticesForNewPyramid(){
    return 216;
}
     ...
     * @return
     */
    GLint NewPyramid::noOfIndicesForFastNewPyramid() {
        return 14;
    }
     ...
     */
    GLint NewPyramid::noOfIndicesForNewPyramid() {
        return 28;
    }
